...
zsh-symlinks:
	...
	@rm -f ~/.zshrc
	@mkdir -p ~/.zsh
	@ln -s ${PWD}/zsh/includes ~/.zsh/includes
	@ln -s ${PWD}/zsh/zshrc ~/.zshrc
	@ln -sf ${PWD}/zsh/zsh_history ~/.zsh_history
	@rm -f ~/.config/sheldon/plugins.toml
	@ln -s ${PWD}/zsh/includes/sheldon.toml ~/.config/sheldon/plugins.toml
	@rm -f ~/.config/starship.toml
	@ln -s ${PWD}/zsh/includes/starship.toml ~/.config/starship.toml
	@rm -f ~/.alias.zsh
	@ln -s ${PWD}/zsh/includes/alias.zsh ~/.alias.zsh
